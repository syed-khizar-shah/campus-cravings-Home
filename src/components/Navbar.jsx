...
const Navbar = () => {
  ...
  return (
    <nav className="flex items-center justify-between fiex top-0 left-0 z-50 px-6 sm:px-8 py-4 bg-[#F3F4FB] w-full relative">
      {/* Logo */}
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            ...
            >
              <a href="#" className="w-full text-center py-2 text-gray-700 hover:text-red-500 transition-colors duration-200">
                Our Mission
              </a>
              <a href="#" className="w-full text-center py-2 text-gray-700 hover:text-red-500 transition-colors duration-200">
                Core Features
